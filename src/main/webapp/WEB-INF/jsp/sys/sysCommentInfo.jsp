                            ...
                            <table class="am-table am-table-striped am-table-hover table-main">
                                ...
                                <c:if test="${!empty TotalList}">
                                    <c:forEach var="admin" items="${requestScope.TotalList}" varStatus="i">
                                        <tr>
                                            <td><input type="checkbox" value="${admin.commentId}" id="ck"></td>
                                            <td>${i.index + 1}</td>
                                            <td class="am-hide-sm-only">${admin.nickName}</td>
                                            <td class="am-hide-sm-only">${admin.blogComment}</td>
                                    ...
                                    <div class="am-fr">
                                        <ul class="am-pagination tpl-pagination">
                                            ...
                                            <c:if test="${page.hasPrePage}">
                                                <li>
                                                    <a href="${pageContext.request.contextPath}/core/v1/tCommentInfo/sysCommentShow/${1}">首页</a>
                                                </li>
                                                <li>
                                                    <a href="${pageContext.request.contextPath}/core/v1/tCommentInfo/sysCommentShow/${page.currentPage -1}">上一页</a>
                                                </li>
                                            </c:if>
                                            <c:if test="!${page.hasPrePage}">
                                                <li> 首页</li>
                                            ...
                                            <c:if test="${page.hasNextPage}">
                                                <li>
                                                    <a href="${pageContext.request.contextPath}/core/v1/tCommentInfo/sysCommentShow/${page.currentPage + 1}">下一页</a>
                                                </li>
                                                <li>
                                                    <a href="${pageContext.request.contextPath}/core/v1/tCommentInfo/sysCommentShow/${page.totalPage}">尾页</a>
                                                </li>
                                            </c:if>
                                            <c:if test="!${page.hasNextPage}">
                                                <li> 下一页</li>
...
<script type="text/javascript">
    ...
    $(".am-btn-delete").click(function () {
        ...
        if (!isChecked) {
            ...
            commentId = $("input[type='checkbox']:checked").val();
                ...
                "buttons": {
                    "确定": function () {
                        ...
                        $.ajax({
                            cache: false,
                            type: "DELETE",
                            url: '<%=request.getContextPath()%>/core/v1/tCommentInfo/delete',
                            data: {
                                "commentId": commentId
                            },
                            dataType: "json",
